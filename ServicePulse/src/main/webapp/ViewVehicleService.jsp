...
<div class="navbar">
  ...
  <a href="branchesjsp">Branches</a>
  <a href="Package.jsp">Packages</a>
</div>

<div class="main-content">
  <div class="card-container">
    <div class="card" onclick="window.location.href='AddCustomerDetails.jsp'">
      <h3>Add Customer Details</h3>
    </div>
    <div class="card" onclick="window.location.href='Vehicle.jsp'">
