...
<body>
    ...
    <div class="row">
        <div class="column">
            <div class="card">
                <img src="img/branch1.jpg" alt="Jane" style="width:100%">
                <div class="container">
        ...
        <div class="column">
            <div class="card">
                <img src="img/branch2.jpg" alt="Mike" style="width:100%">
                <div class="container">
        ...
        <div class="column">
            <div class="card">
                <img src="img/branch3.jpg" alt="John" style="width:100%">
                <div class="container">
        ...
        <div class="column">
            <div class="card">
                <img src="img/branch4.jpg" alt="John" style="width:100%">
                <div class="container">
        ...
        <div class="column">
            <div class="card">
                <img src="img/branch5.jpg" alt="John" style="width:100%">
                <div class="container">
        ...
        <div class="column">
            <div class="card">
                <img src="img/branch6.jpg" alt="John" style="width:100%">
                <div class="container">
